...
makeMakefile('../Inet/Table/Verification/DCB');
...
makeMakefile('../Inet/Record/Verification/Route');
makeMakefile('../Inet/Record/Verification/Dcb');
#=======================================================
...
#=======================================================
makeMakefile('../VHub/Fsm/Verification/Nic');
makeMakefile('../VHub/Fsm/Verification/HBeat');
makeMakefile('../VHub/Plant/Verification/SETUP');
#=======================================================
makeMakefile('../VTap/Fsm/Verification/Sic');
makeMakefile('../VTap/Fsm/Verification/Nic');
makeMakefile('../VTap/Fsm/Verification/HBeat');
makeMakefile('../VTap/Plant/Verification/SETUP');
makeMakefile('../VTap/Collection/Verification/HOST');
#=======================================================
makeMakefile('../VHost/Fsm/Verification/Sic');
makeMakefile('../VHost/Fsm/Verification/Nic');
makeMakefile('../VHost/Fsm/Verification/HBeat');
makeMakefile('../VHost/Plant/Verification/SETUP');
makeMakefile('../VHost/Collection/Verification/HOST');
#=======================================================
